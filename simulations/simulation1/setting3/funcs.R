...
#   var_total <- sd^2 + vary
#   
#   fys <- 0.5*dnorm(y, 0, sqrt(var_total))*dnorm(s, 0, sqrt(var_total)) + 0.5*dnorm(y, 2, sqrt(var_total))*dnorm(s, 2, sqrt(var_total))
#     
#   dyfys <- 0.5*(0-y)/var_total*dnorm(y, 0, sqrt(var_total))*dnorm(s, 0, sqrt(var_total)) + 0.5*(2-y)/var_total*dnorm(y, 2, sqrt(var_total))*dnorm(s, 2, sqrt(var_total))
